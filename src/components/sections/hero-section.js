...
import { formatDateID, getRelationshipStats } from "@/lib/date";
import Reveal from "@/components/ui/reveal";

export default function HeroSection() {
  const stats = getRelationshipStats(anniversaryData.anniversaryDate);
        ...
        <Reveal delay={0.12}>
          <div className="content-block">
            ...
            <p className="meta strong">
              {stats.years} tahun {stats.months} bulan {stats.days} hari bersama
            </p>

            <p className="meta">
              Sudah melewati {stats.totalDays.toLocaleString("id-ID")} hari
              bersama
            </p>
